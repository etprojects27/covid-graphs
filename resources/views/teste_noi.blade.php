...
@section('content')
    ...
    if (date_covid) {
        ...
        Object.keys(date_covid).forEach(function(k){
            ...
            data_array.push(date_covid[k]['nr_teste_noi']);
    ...
    <canvas id="myChart2" style="display: block; width: 400px; height: 400px;" class="chartjs-render-monitor" width="400" height="400"></canvas>
        <script>
            ...
            Object.keys(date_covid).forEach(function(k){
                    ...
                    data_array_cazuri_noi.push(date_covid[k]['nr_teste_definitie_caz']);
                    data_array_reconfirmari.push(date_covid[k]['nr_teste_cerere']);
                    nr_cazuri_pozitive = date_covid[k]['nr_teste_definitie_caz'] + date_covid[k]['nr_teste_cerere'];
                    //se populeaza array-ul ce contine datele din obiectul json
                    data = date_covid[k]['data'];
                    data_formatted = moment(data).format('DD.MM.YYYY');
            ...
            var barChartData = {
                labels: labels_array,
                datasets: [{
                    label: 'Teste definitie caz',
                    backgroundColor: 'rgba(255, 99, 132, 0.2)',
                    data: data_array_cazuri_noi
                }, {
                    label: 'Teste la cerere',
