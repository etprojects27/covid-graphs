...
class ProcentInfectareJudeteController extends BaseController
{
    ...
    public function index()
    {
        ...
        $date_covid_judete_7_zile = Judet::getCazuriTotaleJudeteLastWeek();
        //dd($date_covid_judete_7_zile);

        return view('procent_infectare_judete', ['date_covid' => $date_covid,  'date_covid_1_week' => $date_covid_1_week, 'date_covid_judete_7_zile' => $date_covid_judete_7_zile]);
    }
}