...
class CazuriTotaleJudeteController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('cazuri_totale_judete', ['date_covid' => $date_covid,  'date_covid_1_week' => $date_covid_1_week, 'date_covid_judete_7_zile' => $date_covid_judete_7_zile]);
    }
}